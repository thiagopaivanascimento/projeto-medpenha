...
public class ControleRelaPagamentoConvenio implements ActionListener 
 {
	 private JFrame tela;
     
	 public ControleRelaPagamentoConvenio(JFrame tela)
      {
	   this.tela=tela;
      }
    ...
    public void actionPerformed(ActionEvent evt)
	{
    	...
    	if(aux==true)
    	{
  		  	...
  		  	Vector relaconv = new Vector();
  	 
  	  
      	relaconv= daoconvenio.preencherRelatorioPagConvenio(pag);
						
			//Classe que define o tempo de dado do relatorio
			JRBeanCollectionDataSource jrbean = new JRBeanCollectionDataSource((Vector)relaconv);
			
			Map mapa = new HashMap();
			
			try
			{
				JasperPrint jasperPrint = JasperFillManager.fillReport("..\\MEDPENHA\\relatorios\\documentos\\relpagamentoconvenio.jasper",mapa,jrbean);
